...
if (!class_exists('DUP_Pro_EnhancedGoogleMediaFileUpload'))
{
	...
	class DUP_Pro_EnhancedGoogleMediaFileUpload
	{
		...
		Google_Client $client, Google_Http_Request $request, $mimeType, $data, $resumable = false, $chunkSize = false, $boundary = false, $progress = 0, // RSR NEW Param - allows continuation across different PHP requests
