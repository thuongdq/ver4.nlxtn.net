<?php
/**
 *  The DUPX_API_REQUEST object is a stub for returning an object 
 */
...
/**
 *  The DUPX_API_ERROR object is a stub for returning an object 
 *  error response from a failed request
 */
 ...
 *  https://website.com/dpro-installer/api/router.php/cpnl/create_token/
 * 
...
class DUPX_API_Server 
{
	...
	/* This is called to begin listening to all requests made through 
	 * the router.php request.  If the inbound request is found it will
	 * process the service request. 
	 * 
	 * An example of a request URL is:
	 * //localhost/dpro-installer/api/router.php/cpnl/create_token/{host}/{user}/{pass}/ */
	...
	public function debug_info() 
	{
		...
		echo 'INPUTS:';		DUPX_U::dump($this->args_in);
		echo 'INPUT MAP:';  DUPX_U::dump($this->args_map);
