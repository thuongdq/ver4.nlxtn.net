...
<form id='s3-input-form' method="post" class="content-form" style="line-height:20px">
	...
	<table class="s3-final-step">
		<tr style="display:<?php echo ($subsite_id > 0 ? 'table-row' : 'none')?>">
			<td class='step'><a class='s3-final-btns' href='<?php echo "{$_POST['url_new']}/wp-admin/plugins.php"; ?>' target='_blank'>Enable Plugins</a></td>
			<td>
				<i>					
		...
		<tr>
			<td class='step'><a class='s3-final-btns' href="javascript:void(0)" onclick="DUPX.removeInstallerFiles('<?php echo $GLOBALS['FW_PACKAGE_NAME']; ?>', '<?php echo $GLOBALS['BOOTLOADER_NAME']; ?>')">Security Cleanup</a></td>
	...
	<div class="s3-go-back">
		<i style='font-size:11px'>To re-install <a href="main.installer.php?archive=<?php echo $GLOBALS['FW_PACKAGE_NAME']; ?>">start over at step 1</a>.</i><br/>
	...
	<div id="s3-install-report" style='display:none'>
		...
		<div id="s3-errs-create" class="s3-err-msg">
			<div class="s3-err-title">STEP 1 DEPLOY RESULTS</div>
		...
		<div id="s3-errs-upd" class="s3-err-msg">
			<div class="s3-err-title">STEP 2 UPDATE RESULTS</div>
			<!-- MYSQL QUERY ERRORS -->
