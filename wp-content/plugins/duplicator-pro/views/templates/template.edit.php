...
<div class="dup-box">
	...
	<div class="dup-box-panel" id="dup-template-archive-panel" style="<?php echo $ui_css_archive ?>">
		...
		<input type="checkbox" id="_datbase_filter_on" <?php DUP_PRO_U::echo_checked($package_template->database_filter_on) ?> name="_database_filter_on" />
...
<div class="dup-box">
	...
	<div class="dup-box-panel" id="dup-template-install-panel" style="<?php echo $ui_css_install ?>">
		...
		<b class="dpro-hdr"><i class="fa fa-caret-square-o-right"></i> <?php DUP_PRO_U::_e('SETUP'); ?></b>
		<table>
			<tr>
				<td>
					...
					<div class="secure-pass-area">
						...
						<input type="password" name="_installer_opts_secure_pass" id="_installer_opts_secure_pass" value="<?php echo $installer_pass ?>"  maxlength="50" />
		...
		<b class="dpro-hdr"><i class="fa fa-caret-square-o-right"></i> <?php DUP_PRO_U::_e('STEP 1 - INPUTS'); ?></b>
			...
			<div style="height:550px !important">
				<table class="form-table">
					...
					<tr valign="top">
						...
						<td>
							<input type="checkbox" name="installer_opts_cpnl_enable" id="installer_opts_cpnl_enable" <?php DUP_PRO_U::echo_checked($package_template->installer_opts_cpnl_enable); ?> >
		...
		<table style="margin-left:10px; width: 100%;">
			...
			<tr valign="top">
				...
				<td style="padding-right: 20px; white-space: nowrap; width:150px">
					<input type="checkbox" <?php DUP_PRO_U::echo_checked($package_template->installer_opts_ssl_admin) ?> name="_installer_opts_ssl_admin"  id="_installer_opts_ssl_admin" />
					<label for="_installer_opts_ssl_admin"><?php _e("Enforce On Admin"); ?></label>

				</td>
				<td>
					<input type="checkbox" <?php DUP_PRO_U::echo_checked($package_template->installer_opts_ssl_login) ?> name="_installer_opts_ssl_login"  id="_installer_opts_ssl_login" />
			...
			<tr>
				...
				<td style="padding-right: 20px; white-space: nowrap">
					<input type="checkbox" <?php DUP_PRO_U::echo_checked($package_template->installer_opts_cache_wp) ?> name="_installer_opts_cache_wp" id="_installer_opts_cache_wp" />
					<label for="_installer_opts_cache_wp"><?php _e("Keep Cache Enabled"); ?></label>
				</td>
				<td>
					<input type="checkbox" <?php DUP_PRO_U::echo_checked($package_template->installer_opts_cache_path) ?> name="_installer_opts_cache_path" id="_installer_opts_cache_path" />
