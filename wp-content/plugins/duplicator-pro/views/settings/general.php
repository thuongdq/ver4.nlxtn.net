   ...
   DEBUG SETTINGS -->
    ...
    <table class="form-table">	
        <tr>
            ...
            <td>
                <select name="_logging_mode">
                    <option value="off" <?php DUP_PRO_U::echo_selected($logging_mode == 'off'); ?> ><?php DUP_PRO_U::_e('Off');?></option>
                    <option value="on"  <?php DUP_PRO_U::echo_selected($logging_mode == 'on'); ?>><?php DUP_PRO_U::_e('On');?></option>
                    <option value="enhanced"  <?php DUP_PRO_U::echo_selected($logging_mode == 'enhanced'); ?>><?php DUP_PRO_U::_e('On (Enhanced)');?></option>
                </select>
                <p class="description">
                <?php
        ...
        <tr>
            <th scope="row"></th>
            <td>
                <button class="button" <?php DUP_PRO_U::echo_disabled(DUP_PRO_U::trace_file_exists() === false); ?> onclick="DupPro.Pack.DownloadTraceLog(); return false">
                    <i class="fa fa-download"></i> <?php echo DUP_PRO_U::__('Download Trace Log') . ' (' . DUP_PRO_U::get_trace_log_status() . ')'; ?>
                </button>
            </td>
        </tr>
        <tr>
