            ...
            <td>
                ...
                <?php else : ?>
                    ...
                    <div class="sub-opts">
                        ...
                        <label><?php DUP_PRO_U::_e("Custom Path:"); ?></label><br/>
                ...
                <?php if ($is_zip_available) : ?>
					...
					<div class="sub-opts">
						<i class="fa fa-question-circle" 
							...
							data-tooltip="<?php DUP_PRO_U::_e('Controls shell exec archive compression. Turning compression off can improve build stability and speed however packages will be slightly larger.'); ?>"></i>
						<?php DUP_PRO_U::_e("Archive Compression"); ?>: &nbsp;
						<input type="radio" name="archive_compression" id="archive_compression_on" value="0" <?php echo DUP_PRO_U::echo_checked($global->archive_compression == false); ?> />
						<label for="archive_compression_on"><?php DUP_PRO_U::_e("Off"); ?></label> &nbsp;
						<input type="radio" name="archive_compression"  id="archive_compression_off" value="1" <?php echo DUP_PRO_U::echo_checked($global->archive_compression == true); ?>  />
						<label for="archive_compression_off"><?php DUP_PRO_U::_e("On"); ?></label> 
					</div><br/>
					
				<!-- SHELL EXEC: DISABLED  -->
                <?php else : ?>
					
					<input type="radio" disabled="true"/><label><?php DUP_PRO_U::_e("Shell Exec Zip"); ?> <i class="description"><?php DUP_PRO_U::_e("(recommended)"); ?></i></label> <br/>
					<div class="sub-opts">
						<i class="fa fa-question-circle" 
							data-tooltip-title="<?php DUP_PRO_U::_e("Shell Exec Archive Compression:"); ?>" 
							data-tooltip="<?php DUP_PRO_U::_e('Controls shell exec archive compression. Turning compression off can improve build stability and speed however packages will be slightly larger.'); ?>"></i>
						<?php DUP_PRO_U::_e("Archive Compression"); ?>: &nbsp;
						<input type="radio" disabled="true" /><label><?php DUP_PRO_U::_e("Off"); ?></label> &nbsp;
						<input type="radio" disabled="true" /><label><?php DUP_PRO_U::_e("On"); ?></label> 
						<p class="description" >
							<?php 																								
								$problem_fixes = DUP_PRO_Util::get_shell_exec_zip_problems();
...
//								DUP_PRO_U::_e("If your host is not able or willing to enable Shell Exec zip and you wish to use it please refer to {$providers} for recommended hosts");
				...
				<div class="sub-opts">
					<input type="radio" name="ziparchive_mode" id="ziparchive_mode_1" value="<?php echo DUP_PRO_ZipArchive_Mode::Multithreaded ?>" <?php echo DUP_PRO_U::echo_checked($global->ziparchive_mode == DUP_PRO_ZipArchive_Mode::Multithreaded); ?> onclick="DupPro.UI.EnableBufferSize(true);" />
					<label for="ziparchive_mode_1"><?php DUP_PRO_U::_e("Multi-Threaded"); ?></label> &nbsp; 

					<input type="radio" name="ziparchive_mode" id="ziparchive_mode_2" value="<?php echo DUP_PRO_ZipArchive_Mode::SingleThread ?>" <?php echo DUP_PRO_U::echo_checked($global->ziparchive_mode == DUP_PRO_ZipArchive_Mode::SingleThread); ?> onclick="DupPro.UI.EnableBufferSize(false);" />
					...
					<input style="width:40px;" <?php DUP_PRO_U::echo_disabled($global->ziparchive_mode == DUP_PRO_ZipArchive_Mode::SingleThread); ?> 
...
{
	DupPro.UI.EnableBufferSize = function (enable) 
	{
		$("#ziparchive_chunk_size_in_mb").prop("disabled", !enable);
	}
