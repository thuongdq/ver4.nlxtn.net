		...
		<tr>
			...
			<td>
				...
				<div id="dup-version-info">
                    ...
                    <b><?php DUP_PRO_U::_e("Mysql") ?>:</b> <?php echo strlen($package->VersionDB) ? $package->VersionDB : DUP_PRO_U::__("- unknown -") ?><br/>
                    <b><?php DUP_PRO_U::_e('Mysql Notes') ?>:</b> <?php echo strlen($package->Database->Comments) ? $package->Database->Comments : DUP_PRO_U::__('- unknown -') ?><br/>
				</div>
			</td>
		</tr>		
		<tr>
		...
		<tr>
			<td colspan="2">
				<div id="dpro-pass-toggle">
					<input type="password" name="secure-pass" id="secure-pass" required="required" value="<?php echo DUP_PRO_U::installer_decrypt($package->Installer->OptsSecurePass) ?>" />
