...
require_once (DUPLICATOR_PRO_PLUGIN_PATH . 'classes/ui/class.screen.base.php');

class DUP_PRO_Package_Screen extends DUP_PRO_Screen
{
	...
	public function Init() 
	{
		...
		$this->get_support_tab($guide, $faq);
		$this->get_help_sidbar();
	}	
